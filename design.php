  ...
  <script type="text/javascript">
    ...
    function pop(x)
    {
      if(c==0)
      {
        ...
        c=0;
        window.location.href="http://localhost/files/git/bollywood/design.php?mark=0&Start=Start&";
          }
    }
  </script>
<Center>
...
<form action="design.php" method="GET" id="bw" name="bollywood" >
...
function GETmovie()
{
          ...
          {
                        $connect=mysqli_connect("localhost:3308","root","","bollywood");
...
else
{
  if(isset($_SESSION['guess1']))
  {
    ...
    echo "<div class='guess'><div class='guesstext'>Guess the below movie: </div><br>";
    for($i=0;$i<strlen($_SESSION['guess1']);$i++)
    {
      echo $_SESSION['guess1'][$i]."";
    }
